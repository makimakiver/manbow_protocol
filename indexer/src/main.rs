...
use handlers::{NullEventHandler, TransactionDigestHandler};
...
async fn main() -> Result<()> {
    ...
    // Register our custom sequential pipelines with the cluster
    cluster
        .sequential_pipeline(
    ...
    cluster
        .sequential_pipeline(
            NullEventHandler,            // Indexes NullEvent from manbow_core::presign_events
